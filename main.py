...
# link_configs = "https://codeload.github.com/Khudyakov1/mods_installer/zip/refs/heads/config"
...
# donwload_and_extract(link_configs, location + "\\config\\")
...
profile_data = {
      ...
      "lastUsed" : datetime.datetime.now().isoformat() + 'Z',
